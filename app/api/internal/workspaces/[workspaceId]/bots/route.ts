...
/**
 * GET /api/internal/workspaces/:workspaceId/bots
 * List all bots for the workspace (via workspace_bots junction).
 */
export async function GET(
  ...
  try {
    ...
    console.error("[GET /bots] Unexpected error:", err);
...
/**
 * POST /api/internal/workspaces/:workspaceId/bots
 *
...
export async function POST(
  ...
  try {
    ...
    console.error("[POST /bots] Unexpected error:", err);
    return NextResponse.json(
      {
        error: "Internal server error",
        details: err instanceof Error ? err.message : String(err),
