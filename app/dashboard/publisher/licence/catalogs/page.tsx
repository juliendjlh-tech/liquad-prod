    ...
    <div>
      ...
      <div className="mb-6">
        <div className="flex gap-2 justify-end items-center">
          <Button href="/dashboard/publisher/licence/catalogs/new">Create Catalog</Button>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <Button variant="ghost" href="/dashboard/publisher/licence/catalogs/new">
                    ...
                    items={[
                      {
                        ...
                        onClick: () =>
                          router.push(
                            `/dashboard/publisher/licence/catalogs/${catalog.id}/edit`
                          ),
                      },
                      {
                        label: "Delete",
